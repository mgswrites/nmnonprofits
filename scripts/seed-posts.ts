...
<p>For nonprofits, DAFs represent a massive and underleveraged source of funding. Many organizations focus their fundraising efforts on direct asks, events, and foundation grants. DAF donors are actively looking to give. They have already committed the money to charity. Your job is simply to make sure they know about you.</p>
...
<p>If your donors work with a local community foundation, the relationship can be especially valuable, since community foundation staff often advise donors on where to give locally.</p>
<ul>
...
<p>Start with the low-hanging fruit: update your Candid profile, add your EIN to your donation page, and add one sentence about DAFs to your next year-end appeal. Then begin building relationships with the program officers at New Mexico's community foundations, who are some of the most important connectors in the state's philanthropic ecosystem.</p>
